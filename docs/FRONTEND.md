...
| Route            | Contenu                                                                                                                                                                                                                                                                                                                                                       |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/dashboard`     | Cartes de recherche (meilleur prix, cible, priorité) + flux « Dernières baisses détectées » + **graphique d'activité** (baisses détectées vs confirmées / jour, 30 j)                                                                                                                                                                                         |
| `/searches`      | Tableau + formulaire de création (**autocomplétion aéroport** avec **drapeau**, origine + destinations en chips, `/api/airports`, libellés de classe FR, fenêtre de dates cohérente) + actions (analyser / activer / pause / supprimer)                                                                                                                       |
