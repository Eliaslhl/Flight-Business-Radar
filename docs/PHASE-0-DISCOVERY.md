...
| 4   | **Budget provider réel**          | OK pour ~75–150 €/mois SerpApi dès Phase 7 ? Si budget 0 → on reste sur Mock + scrapers risqués, et la priorité « données fiables » ne peut pas être réellement tenue                    | Détermine la faisabilité du cœur produit      |
...
| 7   | **Mode Radar (sans destination)** | Fournir une liste seed de ~40–60 villes long-courrier au départ de CDG                                                                                                                   | Bloque Phase 9                                |
...
| **10 — AI Advisor**           | Service `FlightAdvisor` : stats structurées en entrée → recommandation en langage naturel en sortie, garde-fous anti-invention + eval                                       | Advisor testé, ne cite que des données du système           |
